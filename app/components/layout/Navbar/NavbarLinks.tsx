    ...
    <ul className='hidden md:flex items-center mr-auto text-text-secondary'>
      ...
      >
        <Link
          href={'/'}
          className={`${
            hoveredIndex !== null && hoveredIndex !== 0 ? 'text-[#ffffff66]' : 'text-text-secondary'
      ...
      >
        <Link
          href={'/'}
          className={`${
            hoveredIndex !== null && hoveredIndex !== 1 ? 'text-[#ffffff66]' : 'text-text-secondary'
          } hidden md:block md:text-[12px] lg:text-[13px] xl:text-[14px] uppercase font-medium transition-all duration-[.4s] ease-in-out active:scale-95 active:opacity-80`}
        >
          Live Betting
        </Link>
      ...
      >
        <Link
          href={'/'}
          className={`${
            hoveredIndex !== null && hoveredIndex !== 2 ? 'text-[#ffffff66]' : 'text-text-secondary'
          } hidden md:block md:text-[12px] lg:text-[13px] xl:text-[14px] uppercase font-medium transition-all duration-[.4s] ease-in-out active:scale-95 active:opacity-80`}
        >
          Live Casino
        </Link>
      ...
      >
        <Link
          href={'/'}
          className={`${
            hoveredIndex !== null && hoveredIndex !== 3 ? 'text-[#ffffff66]' : 'text-text-secondary'
      ...
      >
        <Link
          href={'/'}
          className={`${
            hoveredIndex !== null && hoveredIndex !== 4 ? 'text-[#ffffff66]' : 'text-text-secondary'
      ...
      >
        <Link
          href={'/'}
          className={`${
            hoveredIndex !== null && hoveredIndex !== 5 ? 'text-[#ffffff66]' : 'text-text-secondary'
          } hidden xl:block md:text-[12px] lg:text-[13px] xl:text-[14px] uppercase font-medium transition-all duration-[.4s] ease-in-out active:scale-95 active:opacity-80`}
        >
          VIP
        </Link>
